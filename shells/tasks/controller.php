 ...
 * @lastmodified  $Date: 2009-06-17 11:17:18 +0900 (Wed, 17 Jun 2009) $
 ...
 */
	function bake($controllerName, $actions = '', $helpers = null, $components = null, $uses = null) {
		...
		$out .= "\tpublic \$name = '$controllerName';\n";

		if (low($actions) == 'scaffold') {
			$out .= "\tpublic \$scaffold;\n";
		} else {
			if (count($uses)) {
				$out .= "\tpublic \$uses = array('" . $this->_modelName($controllerName) . "', ";
